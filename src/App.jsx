...
import Joey from "./components/routes/Joey/Joey.jsx";
import CreateTrip from "./components/routes/plan-a-trip/CreateTrip.jsx";
import Mytrips from "./components/routes/my-trips/[trip-id]/Mytrips.jsx";
import Checklist from "./components/routes/checklist/Checklist.jsx";
import TransportationDetails from "./components/routes/my-trips/Elements/TransportationDetails.jsx";
import CostRiskAnalytics from "./components/routes/cost-risk/CostRiskAnalytics.jsx";
      ...
      <div className="app tracking-tighter min-w-[320px]">
        ...
        <div className="container max-w-[1024px] w-full min-w-[320px] h-auto">
          <Routes>
            ...
            <Route
              path="/checklist"
              element={isAuthenticated ? <Checklist /> : <Hero />}
            />
            <Route
              path="/joey"
              element={isAuthenticated ? <Joey /> : <Hero />}
            />
            <Route
              path="/transportation"
              element={isAuthenticated ? <TransportationDetails /> : <Hero />}
            />
            <Route
              path="/cost-risk"
              element={isAuthenticated ? <CostRiskAnalytics /> : <Hero />}
            />
          </Routes>
        </div>
