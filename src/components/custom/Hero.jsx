...
import Joey from "../routes/Joey/Joey"; // Corrected import path
...
function Hero({ heroRef }) {
  ...
  const images = [
    ...
    { name: "Venkateswara Temple", src: "/hero/tirupati.png", link: "https://en.wikipedia.org/wiki/Venkateswara_Temple,_Tirumala" },
    ...
    { name: "Great Pyramid of Giza", src: "/hero/giza.webp", link: "https://en.wikipedia.org/wiki/Great_Pyramid_of_Giza" },
    ...
    { name: "India Gate", src: "/hero/india.webp", link: "https://en.wikipedia.org/wiki/India_Gate" },
    ...
    { name: "Statue of Liberty", src: "/hero/liberty.webp", link: "https://en.wikipedia.org/wiki/Statue_of_Liberty" },
  ...
  return (
    <div ref={heroRef} className="flex items-center flex-col text-center justify-center min-h-screen py-10">
      <div className="text px-10 md:px-40 flex flex-col items-center justify-center gap-4">
        ...
        <div className="buttons flex flex-col gap-3 md:flex-row">
          ...
          <Button variant="outline" onClick={() => setIsChatOpen(true)} className="flex items-center gap-2">
            <MessageCircle className="h-5 w-5" /> Chat with Joey
          </Button>
        </div>
      ...
      <Joey open={isChatOpen} onOpenChange={setIsChatOpen} />
    </div>
  );
}
